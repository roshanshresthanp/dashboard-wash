...
<div class="card card-custom gutter-b">
    <div class="card-body">
            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex justify-content-between flex-wrap mt-1">
                    <div class="d-flex mr-3">
                        ...
                        <a href="#">
                            <i class="flaticon2-correct text-{{($customer->email_verified_at == null)? 'danger' : 'success' }} font-size-h5"></i>
                        </a>
                    </div>
                    <div class="my-lg-0 my-3">
                        <a href="{{route('customers.index')}}" class="btn btn-sm btn-light-danger"><span class="fa fa-times"></i></a>
                ...
                <div class="d-flex flex-wrap justify-content-between mt-1">
                    <div class="d-flex flex-column flex-grow-1 pr-8">
                        <div class="d-flex flex-wrap mb-4">
                            ...
                            <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                            <i class="flaticon2-calendar-3 mr-2 font-size-lg"></i>{{$customer->roles[0]->name}}</a>

                            <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                            <i class="flaticon2-placeholder mr-2 font-size-lg"></i>{{$customer->address}}</a>

                            <a href="#" class="text-dark-50 text-hover-primary font-weight-bold">
                                <i class="flaticon2-phone mr-2 font-size-lg"></i>{{$customer->mobile}}</a>
                        </div>
        ...
        <div class="d-flex align-items-center flex-wrap mt-8">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                <span class="mr-4">
                    <i class="fab fa-bitbucket display-4 text-muted font-weight-bold"></i>
                </span>
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-sm">Buckets</span>
                    <span class="font-weight-bolder font-size-h5">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                <span class="mr-4">
                    <i class="fab fa-opencart display-4 text-muted font-weight-bold"></i>
                </span>
                <div class="d-flex flex-column text-dark-75">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                ...
                <div class="d-flex flex-column">
                    <span class="text-dark-75 font-weight-bolder font-size-sm">SMS</span>
                    <a href="#" class="text-primary font-weight-bolder">View</a>
                </div>
            </div>
            <!--end::Item-->
